...
root.geometry("800x300")  ## 모니터 상에 Window 띄우는 위치 설정 X  WxH+x좌표+y좌표
...
previewLB.pack(side='left', padx=10, pady=10)

## ---------------------------------------------------------------------
## 이벤트 처리 핸들러 정의
## ---------------------------------------------------------------------
## 핸들러기능 : 리스트박스에 선택한 경우 처리
## 핸들러이름 : show_font
