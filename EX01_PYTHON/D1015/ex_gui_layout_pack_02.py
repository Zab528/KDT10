...
## --------------------------------------------------------------------
##- 버튼 인스턴스 생성
b1 = tkinter.Button(window, text="toptoptoptoptoptop")
b1_1=tkinter.Button(window, text="top-1")

b2 = tkinter.Button(window, text="top-2")
b2_1=tkinter.Button(window, text="top-3")

b3 = tkinter.Button(window, text="top-4")
b3_1=tkinter.Button(window, text="top-5")

b4 = tkinter.Button(window, text="top-6")
b4_1=tkinter.Button(window, text="top-7")

b5 = tkinter.Button(window, text="center", bg="red")


##- 버튼 인스턴스를 화면에 pack 방식으로 자동 배치
b1.pack(side="top")                     ##- [기본] 버튼위에 text 보여질 만큼 W, H 크기로 버튼 배치
b1_1.pack(side="top", fill="x")         ##- side='top'인 경우 가로(x축)공간만 확장 가능함

b2.pack(side="top")
b2_1.pack(side="top", anchor="e")

b3.pack(side="top")
b3_1.pack(side="top", fill="y")

b4.pack(side="top")
b4_1.pack(side="top", anchor="s")
